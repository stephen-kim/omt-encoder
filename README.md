...
```bash
cd ~/omt-encode/omtcapture/build
chmod 755 buildlinuxarm64.sh
./buildlinuxarm64.sh
```
...
```bash
~/omt-encode/omtcapture/build/arm64/omtcapture
```
...
sudo cp ~/omt-encode/omtcapture/build/arm64/* /opt/omtcapture/
sudo cp ~/omt-encode/omtcapture/omtcapture.service /etc/systemd/system/
...
- 실행 시: `~/omt-encode/omtcapture/build/arm64/config.xml`
